        ...
        val chart = Chart.apply.newInstance2(canvas, new ChartConfiguration {
          ...
          options = new ChartOptions {
            scales = new ChartScales {
              xAxes = js.Array(new ChartXAxe { // This is a Chart.js V2 type. Why? It compiles but fails at runtime! See readme!
                title = new ChartTitleOptions {
                  display = true
                  text = "Time"
                }
              })
              yAxes = js.Array(new ChartYAxe { // This is a Chart.js V2 type. Why? It compiles but fails at runtime! See readme!
                title = new ChartTitleOptions {
                  display = true
                  text = "Series"
                }
